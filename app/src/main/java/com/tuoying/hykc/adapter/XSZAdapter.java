...
public class XSZAdapter extends BaseAdapter {
    OnItemButtonClickListener listener;
    OnItemClickListener clickListener;
    private Context mContext;
    private List<GoodsEntity> mList;
    private LayoutInflater mInflater;
    public XSZAdapter(Context context, List<GoodsEntity> list) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = mInflater.inflate(R.layout.layout_xsz_item, null);
