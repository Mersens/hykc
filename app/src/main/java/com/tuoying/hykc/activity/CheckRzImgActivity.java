...
public class CheckRzImgActivity extends BaseActivity {
    ...
    private void downLoadImg(String tel){
        ...
        Glide.with(this).load(getUrl(tel,urls[0])).into(mImgCard_Z);
        Glide.with(this).load(getUrl(tel,urls[1])).into(mImgCard_F);
        Glide.with(this).load(getUrl(tel,urls[2])).into(mImgJsz);
        Glide.with(this).load(getUrl(tel,urls[3])).into(mImgXsz);
        Glide.with(this).load(getUrl(tel,urls[4])).into(mImgDlysz);
        Glide.with(this).load(getUrl(tel,urls[5])).into(mImgCyzgz);
        Glide.with(this).load(getUrl(tel,urls[6])).into(mImgXSZ_Z);
        Glide.with(this).load(getUrl(tel,urls[7])).into(mImgXSZ_F);
        Glide.with(this).load(getUrl(tel,urls[8])).into(mImgXSZFB);
        Glide.with(this).load(getUrl(tel,urls[9])).into(mImgGCZL);
        Glide.with(this).load(getUrl(tel,urls[10])).into(mImgGCZLFYF);
