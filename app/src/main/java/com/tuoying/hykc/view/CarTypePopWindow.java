...
public class CarTypePopWindow extends MyPopwindow implements View.OnClickListener {
    ...
    public CarTypePopWindow(Context mContext, View parent) {
        this.context = mContext;
        items = context.getResources().getStringArray(R.array.cx);
